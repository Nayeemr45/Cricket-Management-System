 ...
 *
 //* @author ASUS
 */
public class Nut_info extends javax.swing.JFrame {

    /**
     * Creates new form Nut_info
     */
    public Nut_info() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("vegetarian_mark_90px.png"))); // NOI18N
        jLabel1.setText("NUTRITIONIST  INFORMATION");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"4001", "Siam", "Mogbazar,Dhaka"},
                {"4002", "Kabir", "Malibag,Dhaka"},
                {"4003", "Sabbir", "Mouchak,Dhaka"},
                {"4004", "Fahim", "Mirpur 1,Dhaka"}
            },
            new String [] {
                "NU ID", "NU Name", "NU ADDRESS"
            }
        ) {
  ...
  /*  public static void main(String args[]) {
   ...
   /*     try {
            ...
            java.util.logging.Logger.getLogger(Nut_info.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
